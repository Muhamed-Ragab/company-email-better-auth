...
export const companyEmail = ({ expiresIn = 60 * 60 * 24, disableCleanup = false, allowedEmails = [], generateToken = () => generateRandomString(32), storeCookieAfterVerification = {
    enabled: false,
    ...
    id: "company-email",
    endpoints: {
        sendEmailVerification: createAuthEndpoint("/company-email/send-verification-email", {
            method: "POST",
        ...
        verifyEmailVerification: createAuthEndpoint("/company-email/verify-email", {
            method: "GET",
            ...
            try {
                ...
                if (storeCookieAfterVerification.enabled) {
                    ...
                    ctx.setCookie(storeCookieAfterVerification.cookieName || "temp-verification", generatedToken, {
                        httpOnly: true,
                        secure: true,
                        sameSite: "strict",
                        path: "/",
                        expires: new Date(new Date().setHours(24)),
                    });
                }
                if (!disableCleanup) {
        ...
        checkCompanyEmail: createAuthEndpoint("/company-email/check", {
            method: "POST",
